       ...
       return (
         <div className='action'>
           <Link to={params.row.id} style={{textDecoration:"none"}}>
             <i class="fa-solid fa-pen-to-square" style={{ color: "green", fontSize: "20px" }} onClick={()=>console.log(params.row.id)} ></i>
           </Link>
           <i class="fa-solid fa-trash" style={{color:"red",fontSize:"20px"}}></i>
         </div>
       )
      }
  },
